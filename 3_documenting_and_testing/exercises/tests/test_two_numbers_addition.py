...
import unittest
from ..two_numbers_addition import two_numbers_addition
class TestTwoNumbersAddition(unittest.TestCase):
    """Test the two_numbers_addition function"""

    # Standard test cases
    def test_positive_numbers(self):
        """It should add two positive numbers and return positive"""
        self.assertEqual(two_numbers_addition(2, 3), 5)
    ...
    def test_mixed_numbers(self):
        ...
        self.assertEqual(two_numbers_addition(-2, 3), 1)

    # Edge cases
    def test_minimal_input(self):
        """It should return 0 for two zero inputs"""
        self.assertEqual(two_numbers_addition(0, 0), 0)

    # Defensive tests
    def test_not_integer(self):
        """It should raise AssertionError for non-integer input"""
        with self.assertRaises(AssertionError):
            two_numbers_addition(2, "one")
